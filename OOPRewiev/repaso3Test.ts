...
let xiaomi= new Mobile("Xiaomi","Mi Note 10","Xiaomi",512,"Blanco",true,4,310);
let miArray:Mobile[]=([nokia,iPhone3g,samsung,xiaomi]);
let milibreria = new MobileLibrary("Libreria 2","Cadiz",miArray,0);
milibreria.printLibrary(miArray);